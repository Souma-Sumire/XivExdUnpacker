...
namespace SaintCoinach.Text.Nodes
{
    public class GenericElement : INode, INodeWithChildren, INodeWithArguments, IExpressionNode
    {
        ...
        public GenericElement(TagType tag, INode content, String lenByte, params INode[] arguments)
            : this(tag, content, lenByte, (IEnumerable<INode>)arguments) { }

        public GenericElement(
            TagType tag,
            INode content,
            String lenByte,
            IEnumerable<INode> arguments
        )
        {
            _Tag = tag;
