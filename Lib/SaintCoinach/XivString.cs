...
namespace SaintCoinach.Text
{
    ...
    public class XivString
        : INode,
            ...
            INodeWithChildren,
            IComparable,
            IComparable<XivString>,
            IComparable<string>,
            IEquatable<XivString>,
            IEquatable<string>
    {
        ...
        {
            get { return NodeFlags.HasChildren | NodeFlags.IsExpression; }
        }
        ...
        public XivString(params INode[] children)
            : this((IEnumerable<INode>)children) { }
